...
| 2 | **Part B — Diagnostics Report (PDF)** | [`Week5_Diagnostics_Report_DavidKimathi.pdf`](./Week5_Diagnostics_Report_DavidKimathi.pdf) | 7-page written report for an Operations Director: context, root cause (pump NBI-P03, 34.4% depot throughput loss), supporting charts, and a concrete maintenance-intervention recommendation. |
| 3 | **Part B — Video Presentation** | [`Week5_Presentation_DavidKimathi.mp4`](./Week5_Presentation_DavidKimathi.mp4) | 5-7 minute stakeholder presentation of the findings above, including a simulated skeptical-director Q&A segment. |
